#include "main.hh"
#include "/home/zcandels/geom/cpp/curved_boundaries.cpp"
...
// Initialisation for MPI parallelisationm you can ignore this
    ...
    // Initialize solid labels
    // call the function below for each node. This will label all the solid nodes. Then,
    // can call initialiseBoundaries.
    Geometry<Lattice>::isBulkSolid(curved_boundaries::label_solid_pts(), std::vector<int> neighbors,
